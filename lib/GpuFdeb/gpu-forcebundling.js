...
(function() {
    GPUForceEdgeBundling = function () {
        ...
        function createPrograms() {
            ...
            programSubdivision = gpgpuUility.createProgram(null, gpgpuUility.loadShader('../VITAS-RD/subdivision.glsl'));
            programUpdate = gpgpuUility.createProgram(null, gpgpuUility.loadShader('../VITAS-RD/update.glsl'));
            programCompatibility = gpgpuUility.createProgram(null, gpgpuUility.loadShader('../VITAS-RD/compatibility.glsl'));
        ...
        var forcebundle = function () {
            ...
            // nPoints = P_initial*Math.pow(P_rate, C)+20;
